...
echo "## Argo Status ##"
kubectl --context demo1 -n argocd describe applications prod-bbqbookkeeper | tail -n 5
...
echo ""
echo "## Argo Status ##"
kubectl --context demo2 -n argocd describe applications stage-bbqbookkeeper | tail -n 5
